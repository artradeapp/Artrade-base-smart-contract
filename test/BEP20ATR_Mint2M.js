...
contract('BEP20', (accounts) => {
  ...
  it('Test3 : try to mint after one month', async () => {
    const bep = await BEP20.deployed();
    await time.increaseTo(icoNumber + month);
    await bep.mint(2);
    const balance = await bep.balanceOf(accounts[0]);
    const wallet1  = await bep.balanceOf(accounts[1]);
    const wallet2 = await bep.balanceOf(accounts[2]);
  ...
  it('Test4 : try to mint after 2 month ', async () => {
    const bep = await BEP20.deployed();
    ...
    assert.equal(wallet5.valueOf(),   15189445600000000 + 15189445600000000, "The Ballance W5 should be  0");
    assert.equal(wallet6.valueOf(),  70243377000000000, "The Ballance should be  0");
    assert.equal(balance.valueOf(),  0, "The Balance should be  0");
  ...
  it('Test5 : try a second mint in the same month', async () => {
    const bep = await BEP20.deployed();
    await time.increaseTo(icoNumber + 2 * month + 3 * day);
    await bep.mint(2);
    const balance = await bep.balanceOf(accounts[0]);
    const wallet1  = await bep.balanceOf(accounts[1]);
    const wallet2 = await bep.balanceOf(accounts[2]);
  ...
  it('Test6 : try to mint after 3 month ', async () => {
    const bep = await BEP20.deployed();
    ...
    assert.equal(wallet3.valueOf(),  9289980000000000 , "The Ballance W3 should be  0");
    assert.equal(wallet4.valueOf(),  11205234789911400, "The Ballance W4 should be  0");
    assert.equal(wallet5.valueOf(),   15189445600000000 + 2*15189445600000000, "The Ballance W5 should be  0");
    assert.equal(wallet6.valueOf(),  70243377000000000 , "The Ballance W6 should be  0");
    assert.equal(balance.valueOf(),  0, "The Balance should be  0");
  });
  ...
  it('Test7 : mint loop every month ( 2 mint)', async () => {
   ...
   for (let step = 0; step < 2; step++) {
     await time.increaseTo(icoNumber + 4 * month  + step*month);
     console.log("time      : " + (icoNumber + 4 * month  + step*month));
     ...
     const wallet5 = await bep.balanceOf(accounts[5]);
     const wallet6 = await bep.balanceOf(accounts[6]);
     console.log("value real       : " + wallet5.valueOf());
     ...
     assert.equal(wallet3.valueOf(),  9289980000000000 , "The Ballance W3 should be  0");
     assert.equal(wallet4.valueOf(),  11205234789911400 , "The Ballance W4 should be  0");
     assert.equal(wallet5.valueOf(),   15189445600000000 + (3+step)*15189445600000000, "The Ballance W5 should be  0");
     assert.equal(wallet6.valueOf(),  70243377000000000 , "The Ballance W6 should be  0");
     assert.equal(balance.valueOf(),  0, "The Balance should be  0");
  ...
  it('Test8 : try to mint after 24 month', async () => {
   ...
   const wallet5 = await bep.balanceOf(accounts[5]);
   const wallet6 = await bep.balanceOf(accounts[6]);
   console.log("totale of W4       : " +wallet5.valueOf());
                                         ...
                                         assert.equal(wallet3.valueOf(),  9289980000000000 , "The Ballance W3 should be  0");
                                         assert.equal(wallet4.valueOf(),  11205234789911400 , "The Ballance W4 should be  0");
                                         assert.equal(wallet5.valueOf(),   15189445600000000  + 4*15189445600000000, "The Ballance W5 should be  0");
                                         assert.equal(wallet6.valueOf(),  70243377000000000 , "The Ballance W6 should be  0");
                                         assert.equal(balance.valueOf(),  0, "The Balance should be  0");
  });
